namespace NuGetGallery.Migrations
{
    ...
    public partial class CredentialExpires : DbMigration
    {
        public override void Up()
        {
            ...
            // Set expiration date to 90 days + a random value between 0 and 20 (-> max. 110 days)
            Sql("UPDATE [dbo].[Credentials] SET [Created] =  GETUTCDATE(), [Expires] = DATEADD(Day, 90 + ABS(CHECKSUM(NewId())) % 20, GETUTCDATE()) WHERE [Type] = 'apikey.v1'");
        }
